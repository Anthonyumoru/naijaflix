 * offline-video.js — Companion helper for encrypted offline video
 *
 * Import this in your app to trigger downloads, list cached videos,
 * check if a video is cached, and delete cached videos.
 *
 * Usage:
 *   import { downloadVideo, getCachedVideos, isVideoCached, deleteCachedVideo } from "./offline-video";
 */
...
// ─── Build the full stream URL for a video ────────────────────────────────────
...
// ─── Download a video for encrypted offline playback ──────────────────────────
...
// ─── List all cached (offline) videos ────────────────────────────────────────
